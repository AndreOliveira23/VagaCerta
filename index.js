...
document.getElementById('botao3').style.display = "none"; //Botão de mostrar/ocultar rota inicialmente oculto (só aparece após traçar a rota)
  ...
  $.get(overpassQuery, function(data) {
      ...
      var geojsonLayer = L.geoJson(data, {
          ...
          onEachFeature: function(feature, layer) {
              ...
              var popupContent = '<h5>' + estacionamento.nome + '</h5>' +
                                '<div><b>Endereço:</b> ' + estacionamento.endereco + '</div>' +
                                '<div><b>Lotação:</b> ' + estacionamento.lotacao + '</div>' +
                                '<div><b>Capacidade:</b> ' + estacionamento.capacidade + '</div>' +
                                '<img src="img2.jpg" alt="Imagem do estacionamento" style="width:100%; height:100%;">' ;       
                 
              layer.bindPopup(popupContent, popupOptions);
              estacionamentos.splice(index, 1); // Remove o estacionamento da lista para não ser repetido
          }
      }); 
...
function generateEstacionamentos(){
  return [
      ...
      {nome: "Estacionamento 11", endereco: "Rua 11, 2324, Bairro 11, Cidade 11", lotacao: 50, capacidade: 200},
      {nome: "Estacionamento 12", endereco: "Rua 12, 2526, Bairro 12, Cidade 12", lotacao: 30, capacidade: 100},
      {nome: "Estacionamento 13", endereco: "Rua 13, 2728, Bairro 13, Cidade 13", lotacao: 10, capacidade: 90},
      {nome: "Estacionamento 14", endereco: "Rua 14, 2930, Bairro 14, Cidade 14", lotacao: 75, capacidade: 150},
      {nome: "Estacionamento 15", endereco: "Rua 15, 3132, Bairro 15, Cidade 15", lotacao: 60, capacidade: 200},
      {nome: "Estacionamento 16", endereco: "Rua 16, 3334, Bairro 16, Cidade 16", lotacao: 20, capacidade: 80},
      {nome: "Estacionamento 17", endereco: "Rua 17, 3536, Bairro 17, Cidade 17", lotacao: 100, capacidade: 100},
      {nome: "Estacionamento 18", endereco: "Rua 18, 3738, Bairro 18, Cidade 18", lotacao: 40, capacidade: 50},
      {nome: "Estacionamento 19", endereco: "Rua 19, 3940, Bairro 19, Cidade 19", lotacao: 15, capacidade: 70},
      {nome: "Estacionamento 20", endereco: "Rua 20, 4142, Bairro 20, Cidade 20", lotacao: 55, capacidade: 110},
      {nome: "Estacionamento 21", endereco: "Rua 21, 4344, Bairro 21, Cidade 21", lotacao: 90, capacidade: 150},
      {nome: "Estacionamento 22", endereco: "Rua 22, 4546, Bairro 22, Cidade 22", lotacao: 10, capacidade: 200},
      {nome: "Estacionamento 23", endereco: "Rua 23, 4748, Bairro 23, Cidade 23", lotacao: 25, capacidade: 120},
      {nome: "Estacionamento 24", endereco: "Rua 24, 4950, Bairro 24, Cidade 24", lotacao: 70, capacidade: 90},
      {nome: "Estacionamento 25", endereco: "Rua 25, 5152, Bairro 25, Cidade 25", lotacao: 35, capacidade: 110},
      {nome: "Estacionamento 26", endereco: "Rua 26, 5354, Bairro 26, Cidade 26", lotacao: 30, capacidade: 60},
      {nome: "Estacionamento 27", endereco: "Rua 27, 5556, Bairro 27, Cidade 27", lotacao: 60, capacidade: 90},
      {nome: "Estacionamento 28", endereco: "Rua 28, 5758, Bairro 28, Cidade 28", lotacao: 85, capacidade: 100},
      {nome: "Estacionamento 29", endereco: "Rua 29, 5960, Bairro 29, Cidade 29", lotacao: 20, capacidade: 50},
      {nome: "Estacionamento 30", endereco: "Rua 30, 6162, Bairro 30, Cidade 30", lotacao: 90, capacidade: 200},
      {nome: "Estacionamento 31", endereco: "Rua 31, 6364, Bairro 31, Cidade 31", lotacao: 40, capacidade: 80},
      {nome: "Estacionamento 32", endereco: "Rua 32, 6566, Bairro 32, Cidade 32", lotacao: 60, capacidade: 150},
      {nome: "Estacionamento 33", endereco: "Rua 33, 6768, Bairro 33, Cidade 33", lotacao: 20, capacidade: 120},
      {nome: "Estacionamento 34", endereco: "Rua 34, 6970, Bairro 34, Cidade 34", lotacao: 100, capacidade: 200},
      {nome: "Estacionamento 35", endereco: "Rua 35, 7172, Bairro 35, Cidade 35", lotacao: 15, capacidade: 80},
      {nome: "Estacionamento 36", endereco: "Rua 36, 7374, Bairro 36, Cidade 36", lotacao: 110, capacidade: 150},
      {nome: "Estacionamento 37", endereco: "Rua 37, 7576, Bairro 37, Cidade 37", lotacao: 30, capacidade: 90},
      {nome: "Estacionamento 38", endereco: "Rua 38, 7778, Bairro 38, Cidade 38", lotacao: 20, capacidade: 40},
      {nome: "Estacionamento 39", endereco: "Rua 39, 7980, Bairro 39, Cidade 39", lotacao: 50, capacidade: 100},
      {nome: "Estacionamento 40", endereco: "Rua 40, 8182, Bairro 40, Cidade 40", lotacao: 120, capacidade: 250},
      {nome: "Estacionamento 41", endereco: "Rua 41, 8384, Bairro 41, Cidade 41", lotacao: 60, capacidade: 120},
      {nome: "Estacionamento 42", endereco: "Rua 42, 8586, Bairro 42, Cidade 42", lotacao: 90, capacidade: 140},
      {nome: "Estacionamento 43", endereco: "Rua 43, 8788, Bairro 43, Cidade 43", lotacao: 75, capacidade: 100},
      {nome: "Estacionamento 44", endereco: "Rua 44, 8990, Bairro 44, Cidade 44", lotacao: 50, capacidade: 70},
      {nome: "Estacionamento 45", endereco: "Rua 45, 9192, Bairro 45, Cidade 45", lotacao: 15, capacidade: 30},
      {nome: "Estacionamento 46", endereco: "Rua 46, 9394, Bairro 46, Cidade 46", lotacao: 80, capacidade: 90},
      {nome: "Estacionamento 47", endereco: "Rua 47, 9596, Bairro 47, Cidade 47", lotacao: 25, capacidade: 70},
      {nome: "Estacionamento 48", endereco: "Rua 48, 9798, Bairro 48, Cidade 48", lotacao: 60, capacidade: 110},
      {nome: "Estacionamento 49", endereco: "Rua 49, 9999, Bairro 49, Cidade 49", lotacao: 30, capacidade: 90},
      {nome: "Estacionamento 50", endereco: "Rua 50, 10000, Bairro 50, Cidade 50", lotacao: 100, capacidade: 150}
    ]
}